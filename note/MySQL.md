...
port=3306
socket=/tmp/mysql.sock
language=/home/rsjhs/programs/mysql/share/english
basedir=/home/rsjhs/programs/mysql
datadir=/home/rsjhs/programs/mysql/data
pid_file=/home/rsjhs/programs/mysql/mysql.pid
...
#-----------------------------------------日志设置-----------------------------------------
#错误日志
log_error=/home/rsjhs/programs/mysql/logs/error.log
#慢查询日志
long_query_time=1 
slow_query_log=1
slow_query_log_file=/home/rsjhs/programs/mysql/logs/mysql-slow.log
#一般查询日志
general_log=1
general_log_file=/home/rsjhs/programs/mysql/logs/mysql-general.log
#-----------------------------------------基本设置-----------------------------------------
#设置默认时区
